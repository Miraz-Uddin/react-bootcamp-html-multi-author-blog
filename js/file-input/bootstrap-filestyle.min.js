 ...
 *
 * Copyright (c) 2023 Markus Vinicius da Silva Lima
 * Version 1.0.3
  ...
  c.prototype = {
    ...
    classButton: function (d) {
      if (d !== undefined) {
        ...
        this.$elementFilestyle
          .find("label")
          .attr({ class: this.options.classButton });
        if (
          this.options.classButton.search(
            /btn-inverse|btn-primary|btn-danger|btn-warning|btn-success/i
          ) !== -1
        ) {
      ...
      if (d !== undefined) {
        ...
        if (
          ...
          this.$elementFilestyle
            .find("label")
            .find("i")
            .attr({ class: "icon-white " + this.options.classIcon });
        } else {
          this.$elementFilestyle
            .find("label")
            .find("i")
            .attr({ class: this.options.classIcon });
        }
      } else {
    ...
    constructor: function () {
      ...
      d =
        ...
        g +
        '" class="' +
        this.options.classButton +
        '">' +
        this.htmlIcon() +
        "<span>" +
        this.options.buttonText +
        "</span></label>";
      this.$elementFilestyle = b(
