 ...
 * Copyright 2023-2014 Twitter, Inc. and other contributors; Licensed MIT
 */
...
!(function (a) {
  var b = {
    ...
    d = (function () {
      ...
      return {
        nonword: b,
        whitespace: a,
        obj: { nonword: c(b), whitespace: c(a) },
      };
    })(),
    e = (function () {
      function a(a) {
        ...
        b.mixin(c.prototype, {
          _get: function (a, b, c) {
            ...
            (k = g[a])
              ? k.done(d).fail(e)
              : h > f
              ? (f++, (g[a] = this._send(a, b).done(d).fail(e).always(j)))
  ...
  b.isMsie() &&
    ...
    b.isMsie() && b.isMsie() <= 7 && b.mixin(k.input, { marginTop: "-1px" });
  var l = (function () {
      function c(b) {
          ...
          _render: function (c, d) {
            ...
            function f() {
              ...
              return (
                ...
                (l = b.map(d, e)),
                f.append.apply(f, l),
                p.highlight && n({ node: f[0], pattern: c }),
                f
              );
            }
            function l() {
