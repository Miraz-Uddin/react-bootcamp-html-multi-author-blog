...
Copyright (c) 2007-2023 IOLA and Ole Laursen.
  ...
  (e.color = {}),
    (e.color.make = function (t, n, r, i) {
      ...
      return (
        ...
        (s.toString = function () {
          return s.a >= 1
            ? "rgb(" + [s.r, s.g, s.b].join(",") + ")"
            : "rgba(" + [s.r, s.g, s.b, s.a].join(",") + ")";
        }),
  ...
  (function (e) {
    ...
    function r(t, r, s, o) {
      ...
      function x(n) {
        e.extend(!0, a, n),
          ...
          a.xaxis.color == null &&
            (a.xaxis.color = e.color
              .parse(a.grid.color)
              .scale("a", 0.22)
              .toString()),
          a.yaxis.color == null &&
            (a.yaxis.color = e.color
              .parse(a.grid.color)
              .scale("a", 0.22)
              .toString()),
          a.xaxis.tickColor == null &&
            (a.xaxis.tickColor = a.grid.tickColor || a.xaxis.color),
          a.yaxis.tickColor == null &&
            (a.yaxis.tickColor = a.grid.tickColor || a.yaxis.color),
          a.grid.borderColor == null && (a.grid.borderColor = a.grid.color),
          a.grid.tickColor == null &&
            (a.grid.tickColor = e.color
              .parse(a.grid.color)
              .scale("a", 0.22)
              .toString());
        var r,
          ...
          o = {
            ...
            size: Math.round(
              0.8 * (+t.css("font-size").replace("px", "") || 13)
            ),
        ...
        a.xaxis.noTicks &&
          a.xaxis.ticks == null &&
          (a.xaxis.ticks = a.xaxis.noTicks),
          a.yaxis.noTicks &&
            a.yaxis.ticks == null &&
            (a.yaxis.ticks = a.yaxis.noTicks),
          a.x2axis &&
          ...
          a.grid.coloredAreasColor &&
            (a.grid.markingsColor = a.grid.coloredAreasColor),
          ...
          a.highlightColor != null &&
            (a.series.highlightColor = a.highlightColor);
      ...
      function C(e, t) {
        var n = e[t + "axis"];
        return (
          typeof n == "object" && (n = n.n), typeof n != "number" && (n = 1), n
        );
      }
      function k() {
      ...
      function _() {
              ...
              for (a = 0; a < h; ++a)
                (m = c[o + a]),
                  m != null &&
                    ((g = S[a]),
                    g.autoscale &&
                      (g.x && x(l.xaxis, m, m), g.y && x(l.yaxis, m, m))),
                  (c[o + a] = null);
            else if (
              N &&
              o > 0 &&
        ...
        for (i = 0; i < u.length; ++i) {
          ...
          if (l.bars.show) {
            ...
            l.bars.horizontal
              ? ((A += _), (M += _ + l.bars.barWidth))
              : ((L += _), (O += _ + l.bars.barWidth));
          }
        ...
        isNaN(+s) || (u += +s),
          t.direction == "x"
            ? ((r += u),
              i == "bottom"
                ? ((m.bottom += r + o),
                  (t.box = { top: f.height - m.bottom, height: r }))
                : ((t.box = { top: m.top + o, height: r }), (m.top += r + o)))
            : ((n += u),
              i == "left"
                ? ((t.box = { left: m.left + o, width: n }), (m.left += n + o))
                : ((m.right += n + o),
                  (t.box = { left: f.width - m.right, width: n }))),
          (t.position = i),
          (t.tickLength = s),
          (t.box.padding = u),
          (t.innermost = h);
      ...
      function q() {
        ...
        if (t == null) {
          ...
          for (r = 0; r < u.length; ++r)
            t = Math.max(
              t,
              2 * (u[r].points.radius + u[r].points.lineWidth / 2)
            );
        }
        (n.x = n.y = Math.ceil(t)),
          e.each(k(), function (e, t) {
            ...
            t.reserveSpace &&
              (n[r] = Math.ceil(
                Math.max(n[r], (r == "x" ? t.labelWidth : t.labelHeight) / 2)
              ));
          }),
      ...
      function R() {
        ...
        E(b.processOffset, [m]);
        for (var i in m)
          typeof a.grid.borderWidth == "object"
      ...
      function z(t) {
        var n = t.options,
          r;
        typeof n.ticks == "number" && n.ticks > 0
          ? (r = n.ticks)
          : (r = 0.3 * Math.sqrt(t.direction == "x" ? f.width : f.height));
        var s = (t.max - t.min) / r,
        ...
        l < 1.5
          ? (c = 1)
          : l < 3
          ? ((c = 2), l > 2.25 && (u == null || o + 1 <= u) && ((c = 2.5), ++o))
          : l < 7.5
          ? (c = 5)
          : (c = 10),
          (c *= a),
        ...
        t.tickGenerator ||
          ...
          (t.tickFormatter = function (e, t) {
            ...
            if (t.tickDecimals != null) {
              ...
              if (s < t.tickDecimals)
                return (
                  (s ? r : r + ".") + ("" + n).substr(1, t.tickDecimals - s)
                );
            }
            return r;
          })),
        ...
        if (n.alignTicksWithAxis != null) {
          ...
          if (h && h.used && h != t) {
            ...
            if (!t.mode && n.tickDecimals == null) {
              var m = Math.max(
                  0,
                  -Math.floor(Math.log(t.delta) / Math.LN10) + 1
                ),
                g = t.tickGenerator(t);
        ...
        for (var l = 0; l < n.length; ++l) {
          ...
          (h.lineWidth = 1),
            c.direction == "x"
              ? ((v = 0),
                d == "full"
                  ? (b = c.position == "top" ? 0 : y)
                  : (b = p.top - m.top + (c.position == "top" ? p.height : 0)))
              : ((b = 0),
                d == "full"
                  ? (v = c.position == "left" ? 0 : g)
                  : (v =
                      p.left - m.left + (c.position == "left" ? p.width : 0))),
            c.innermost ||
          ...
          for (t = 0; t < c.ticks.length; ++t) {
            ...
            if (
              ...
              x > c.max ||
              (d == "full" &&
                ((typeof r == "object" && r[c.position] > 0) || r > 0) &&
                (x == c.min || x == c.max))
            )
              continue;
            c.direction == "x"
          ...
          for (var h = 0; h < t.ticks.length; ++h) {
            ...
            t.direction == "x"
              ? ((l = "center"),
                ...
                t.position == "bottom"
                  ? (a = n.top + n.padding)
                  : ((a = n.top + n.height - n.padding), (c = "bottom")))
              : ((c = "middle"),
                (a = m.top + t.p2c(o.v)),
                t.position == "left"
                  ? ((u = n.left + n.width - n.padding), (l = "right"))
                  : (u = n.left + n.padding)),
        ...
        function n(e, t, n) {
          ...
          for (;;) {
            ...
            var g = p,
              y = v;
            d <= m && d < n.min && m >= n.min
              ? ((p = ((n.min - d) / (m - d)) * (v - p) + p), (d = n.min))
              : m <= d &&
                m < n.min &&
                d >= n.min &&
                ((v = ((n.min - d) / (m - d)) * (v - p) + p), (m = n.min)),
              d >= m && d > n.max && m <= n.max
                ? ((p = ((n.max - d) / (m - d)) * (v - p) + p), (d = n.max))
                : m >= d &&
                  m > n.max &&
                  d <= n.max &&
                  ((v = ((n.max - d) / (m - d)) * (v - p) + p), (m = n.max)),
              p != g && h.lineTo(t.p2c(g), n.p2c(d)),
              h.lineTo(t.p2c(p), n.p2c(d)),
              h.lineTo(t.p2c(v), n.p2c(m)),
              v != y &&
                (h.lineTo(t.p2c(v), n.p2c(m)), h.lineTo(t.p2c(y), n.p2c(m)));
          }
        }
        ...
        function t(e, t, n, r, i, s, o, u) {
          ...
          for (var l = 0; l < a.length; l += f) {
            ...
            h.beginPath(),
              ...
              (p = o.p2c(p) + r),
              u == "circle"
                ? h.arc(c, p, t, 0, i ? Math.PI : Math.PI * 2, !1)
                : u(h, c, p, t, i),
              h.closePath(),
      ...
      function rt(t, n, r, i) {
        ...
        return (
          (o.a = typeof s == "number" ? s : 0.4), o.normalize(), o.toString()
        );
      }
      function it() {
        ...
        for (var l = 0; l < u.length; ++l)
          (o = u[l]),
            o.label &&
              ...
              f && r.push({ label: f, color: o.color }));
        if (a.legend.sorted)
        ...
        for (var l = 0; l < r.length; ++l) {
          var h = r[l];
          l % a.legend.noColumns == 0 &&
            (i && n.push("</tr>"), n.push("<tr>"), (i = !0)),
            n.push(
        ...
        if (a.legend.container != null) e(a.legend.container).html(p);
          ...
          g[0] == null && (g = [g, g]),
            v.charAt(0) == "n"
              ? (d += "top:" + (g[1] + m.top) + "px;")
              : v.charAt(0) == "s" &&
                (d += "bottom:" + (g[1] + m.bottom) + "px;"),
            v.charAt(1) == "e"
              ? (d += "right:" + (g[0] + m.right) + "px;")
              : v.charAt(1) == "w" && (d += "left:" + (g[0] + m.left) + "px;");
          var y = e(
            '<div class="legend">' +
          ...
          if (a.legend.backgroundOpacity != 0) {
            ...
            b == null &&
              ...
              b && typeof b == "string"
                ? (b = e.color.parse(b))
                : (b = e.color.extract(y, "background-color")),
              (b.a = 1),
              (b = b.toString()));
            var w = y.children();
            e(
      ...
      function ct(e, n, r) {
        ...
        f &&
          ((f.pageX = parseInt(
            f.series.xaxis.p2c(f.datapoint[0]) + i.left + m.left,
            10
          )),
          (f.pageY = parseInt(
            f.series.yaxis.p2c(f.datapoint[1]) + i.top + m.top,
            10
          )));
        if (a.grid.autoHighlight) {
          for (var l = 0; l < st.length; ++l) {
            ...
            h.auto == e &&
              (!f ||
                h.series != f.series ||
                h.point[0] != f.datapoint[0] ||
                h.point[1] != f.datapoint[1]) &&
              vt(h.series, h.point);
          }
      ...
      function dt(e, t, n) {
        ...
        var i = mt(e, t);
        i == -1
          ? (st.push({ series: e, point: t, auto: n }), ht())
          : n || (st[i].auto = !1);
      }
      function vt(e, t) {
        if (e == null && t == null) {
      ...
      function gt(t, n) {
        var r = n[0],
          ...
          o = t.yaxis,
          u =
            typeof t.highlightColor == "string"
              ? t.highlightColor
              : e.color.parse(t.color).scale("a", 0.5).toString();
        ...
        (r = s.p2c(r)),
          (i = o.p2c(i)),
          p.beginPath(),
          t.points.symbol == "circle"
            ? p.arc(r, i, f, 0, 2 * Math.PI, !1)
            : t.points.symbol(p, r, i, f, !1),
          p.closePath(),
          p.stroke();
      }
      function yt(t, n) {
    ...
    (n.prototype.resize = function (e, t) {
      ...
      var n = this.element,
        ...
        i = this.pixelRatio;
      this.width != e &&
        ((n.width = e * i), (n.style.width = e + "px"), (this.width = e)),
        this.height != t &&
          ((n.height = t * i), (n.style.height = t + "px"), (this.height = t)),
        r.restore(),
        r.save(),
        r.scale(i, i);
    }),
                ...
                for (var u in o)
                  if (t.call(o, u)) {
                    ...
                    for (var f = 0, l; (l = a[f]); f++)
                      l.active
                        ? l.rendered || (r.append(l.element), (l.rendered = !0))
                        : (a.splice(f--, 1), l.rendered && l.element.detach());
      ...
      (n.prototype.getTextInfo = function (t, n, r, i, s) {
        ...
        if (f == null) {
          var l = e("<div></div>")
            .html(n)
            .css({ position: "absolute", "max-width": s, top: -9999 })
            .appendTo(this.getTextLayer(t));
          typeof r == "object"
            ? l.css({ font: o, color: r.color })
