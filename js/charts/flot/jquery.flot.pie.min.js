...
*/ (function (e) {
  function r(r) {
    ...
    function d(t) {
      ...
      for (var a = 0; a < t.length; ++a) {
        ...
        e.isArray(f) && f.length == 1 && (f = f[0]),
          e.isArray(f)
            ? !isNaN(parseFloat(f[1])) && isFinite(f[1])
              ? (f[1] = +f[1])
              : (f[1] = 0)
            : !isNaN(parseFloat(f)) && isFinite(f)
            ? (f = [1, +f])
            : (f = [1, 0]),
          (t[a].data = [f]);
      }
      ...
      for (var a = 0; a < t.length; ++a) {
        var f = t[a].data[0][1];
        (s < 2 || f / n > i.series.pie.combine.threshold) &&
          u.push({
            data: [[1, f]],
            color: t[a].color,
            label: t[a].label,
    ...
    function v(r, s) {
      ...
      function w() {
        function l(e, t, i) {
          ...
          i ? (c.fillStyle = t) : ((c.strokeStyle = t), (c.lineJoin = "round")),
            c.beginPath(),
        ...
        function d() {
          function l(t, n, s) {
            ...
            var u = i.legend.labelFormatter,
              l,
              c = i.series.pie.label.formatter;
            ...
            if (i.series.pie.label.background.opacity != 0) {
              ...
              e(
                ...
                .css("opacity", i.series.pie.label.background.opacity)
                .insertBefore(y);
            }
            return !0;
          }
          var n = t,
            r =
              i.series.pie.label.radius > 1
                ? i.series.pie.label.radius
                : u * i.series.pie.label.radius;
          for (var s = 0; s < v.length; ++s) {
            if (
              v[s].percent >= i.series.pie.label.threshold * 100 &&
              !l(v[s], n, s)
            )
              return !1;
            n += v[s].angle;
      ...
      (c = s),
        ...
        (a = h / 2),
        i.series.pie.offset.left == "auto"
          ? i.legend.position.match("w")
            ? (a += d / 2)
            : (a -= d / 2)
          : (a += i.series.pie.offset.left),
        a < u ? (a = u) : a > h - u && (a = h - u);
      var v = r.getData(),
        g = 0;
      do g > 0 && (u *= n), (g += 1), y(), i.series.pie.tilt <= 0.8 && b();
      while (!w() && g < t);
      g >= t &&
        (y(),
        o.prepend(
        ...
        r.setSeries && r.insertLegend && (r.setSeries(v), r.insertLegend());
    }
    function m(e) {
      if (i.series.pie.innerRadius > 0) {
        e.save();
        var t =
          i.series.pie.innerRadius > 1
    ...
    function g(e, t) {
      for (var n = !1, r = -1, i = e.length, s = i - 1; ++r < i; s = r)
        ((e[r][1] <= t[1] && t[1] < e[s][1]) ||
          (e[s][1] <= t[1] && t[1] < e[r][1])) &&
          t[0] <
            ((e[s][0] - e[r][0]) * (t[1] - e[r][1])) / (e[s][1] - e[r][1]) +
              e[r][0] &&
          (n = !n);
      return n;
    }
    ...
    function S(e, t) {
      var n = T(e);
      n == -1
        ? (h.push({ series: e, auto: t }), r.triggerRedrawOverlay())
        : t || (h[n].auto = !1);
    }
    function x(e) {
    ...
    function N(e, t) {
      function s(e) {
        ...
        (t.fillStyle =
          "rgba(255, 255, 255, " + n.series.pie.highlight.opacity + ")"),
          t.beginPath(),
    ...
    r.hooks.processOptions.push(function (e, t) {
      t.series.pie.show &&
        ((t.grid.show = !1),
        t.series.pie.label.show == "auto" &&
          (t.legend.show
            ? (t.series.pie.label.show = !1)
            : (t.series.pie.label.show = !0)),
        t.series.pie.radius == "auto" &&
